...
- Allows for the creation of comments on posts, with a per-post ability to disable comments and all comments requiring approval by the admin. Amin can now delete comments as well. ***Comment editing functionality will never be implemented.***
