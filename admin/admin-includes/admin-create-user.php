...
EOHTML;
    ...
    echo<<<EOHTML
    <div class="alert alert-danger alert-dismissible show" role="alert">Profile Created!<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span>  </button> </div><br/>
EOHTML;
  }
}
?>
